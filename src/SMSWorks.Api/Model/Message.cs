...
namespace SMSWorks.Api.Model
{
    ...
    public partial class Message : IValidatableObject
    {
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for Validity, must be a value less than or equal to 2880.", new [] { "Validity" });
            }

            // Validity (decimal) minimum
            if (this.Validity < (decimal)1)
            {
                yield return new ValidationResult("Invalid value for Validity, must be a value greater than or equal to 1.", new [] { "Validity" });
            }
