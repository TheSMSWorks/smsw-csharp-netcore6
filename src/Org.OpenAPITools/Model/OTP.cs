...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class OTP : IEquatable<OTP>, IValidatableObject
    {
        ...
        public OTP(string sender = default(string), string destination = default(string), string template = default(string), decimal validity = default(decimal), string passcode = default(string), Object metadata = default(Object))
        {
            this.Sender = sender;
