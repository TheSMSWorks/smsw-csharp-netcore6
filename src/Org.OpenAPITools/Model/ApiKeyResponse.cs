...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ApiKeyResponse : IEquatable<ApiKeyResponse>, IValidatableObject
    {
        ...
        public ApiKeyResponse(string key = default(string), string secret = default(string))
        {
            ...
            if (key == null)
            {
                throw new ArgumentNullException("key is a required property for ApiKeyResponse and cannot be null");
            }
            this.Key = key;
            // to ensure "secret" is required (not null)
            if (secret == null)
            {
                throw new ArgumentNullException("secret is a required property for ApiKeyResponse and cannot be null");
            }
            this.Secret = secret;
        }
