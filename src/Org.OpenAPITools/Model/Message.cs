...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Message : IEquatable<Message>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.Validity > (decimal)2.88E+3)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Validity, must be a value less than or equal to 2.88E+3.", new [] { "Validity" });
            }
